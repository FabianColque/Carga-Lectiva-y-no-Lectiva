/*
       ...
       Generated on: 12/3/2014 8:48:44.51
...
namespace GeneXus.Programs {
   public class promptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm032( )
      {
         ...
         context.AddJavascriptSource("promptmasterpage.js", "?8484452");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( getDataAreaObject().GetForm().Jscriptsrc.Item(idxLst)), "?8484458");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("promptmasterpage.js", "?8484458");
         }
