/*
       ...
       Generated on: 9/28/2014 22:13:7.63
...
namespace GeneXus.Programs {
   public class gx00b1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( short aP0_pCargaLectivaId ,
                           ...
                           out short aP2_pAsignaturaId )
      {
         this.AV9pCargaLectivaId = aP0_pCargaLectivaId;
         this.AV10pDocenteId = 0 ;
         this.AV11pAsignaturaId = 0 ;
         executePrivate();
         aP1_pDocenteId=this.AV10pDocenteId;
         aP2_pAsignaturaId=this.AV11pAsignaturaId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7cAsignaturaId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7cAsignaturaId), 4, 0)));
               AV8cDocenteNombres = GetNextPar( ) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDocenteNombres", AV8cDocenteNombres);
               AV12cCategoriaId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cCategoriaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12cCategoriaId), 4, 0)));
               AV9pCargaLectivaId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pCargaLectivaId), 4, 0)));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize36, AV6cDocenteId, AV7cAsignaturaId, AV8cDocenteNombres, AV12cCategoriaId, AV9pCargaLectivaId) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV9pCargaLectivaId = (short)(NumberUtil.Val( gxfirstwebparm, ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pCargaLectivaId), 4, 0)));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV10pDocenteId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pDocenteId), 4, 0)));
                  AV11pAsignaturaId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pAsignaturaId), 4, 0)));
               }
            }
         }
         context.SetTheme("Modern");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx00b1.aspx") + "?" + UrlEncode("" +AV9pCargaLectivaId) + "," + UrlEncode("" +AV10pDocenteId) + "," + UrlEncode("" +AV11pAsignaturaId)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCASIGNATURAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cAsignaturaId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCDOCENTENOMBRES", StringUtil.RTrim( AV8cDocenteNombres));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGORIAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cCategoriaId), 4, 0, ",", "")));
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, "nRC_Grid1", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_Grid1), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPCARGALECTIVAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pCargaLectivaId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPDOCENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10pDocenteId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPASIGNATURAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11pAsignaturaId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx00b1.aspx") + "?" + UrlEncode("" +AV9pCargaLectivaId) + "," + UrlEncode("" +AV10pDocenteId) + "," + UrlEncode("" +AV11pAsignaturaId) ;
      }
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( ( context.localUtil.CToN( cgiGet( "GXH_vCASIGNATURAID"), ",", ".") != Convert.ToDecimal( AV7cAsignaturaId )) )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( StringUtil.StrCmp(cgiGet( "GXH_vCDOCENTENOMBRES"), AV8cDocenteNombres) != 0 )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                  if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCATEGORIAID"), ",", ".") != Convert.ToDecimal( AV12cCategoriaId )) )
                  {
                     GRID1_nFirstRecordOnPage = 0 ;
                  }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtDocenteId_Internalname = "DOCENTEID_"+sGXsfl_36_idx ;
                              edtAsignaturaId_Internalname = "ASIGNATURAID_"+sGXsfl_36_idx ;
                              edtDocenteNombres_Internalname = "DOCENTENOMBRES_"+sGXsfl_36_idx ;
                              edtCargaLectivaId_Internalname = "CARGALECTIVAID_"+sGXsfl_36_idx ;
      ...
      protected void gxgrGrid1_refresh( int Grid1_PageSize36 ,
                                        short AV6cDocenteId ,
                                        short AV7cAsignaturaId ,
                                        String AV8cDocenteNombres ,
                                        short AV12cCategoriaId ,
                                        short AV9pCargaLectivaId )
      {
         GxWebStd.set_html_headers( context, 0, "", "");
         disableOutput();
      ...
      protected void RF0D2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            edtDocenteNombres_Internalname = "DOCENTENOMBRES_"+sGXsfl_36_idx ;
            edtCargaLectivaId_Internalname = "CARGALECTIVAID_"+sGXsfl_36_idx ;
            lV8cDocenteNombres = StringUtil.PadR( StringUtil.RTrim( AV8cDocenteNombres), 100, "%") ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDocenteNombres", AV8cDocenteNombres);
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {AV9pCargaLectivaId, AV6cDocenteId, AV7cAsignaturaId, lV8cDocenteNombres, AV12cCategoriaId});
            nGXsfl_36_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A7CategoriaId = H000D2_A7CategoriaId[0] ;
               ...
               A18CargaLectivaId = H000D2_A18CargaLectivaId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A18CargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(A18CargaLectivaId), 4, 0)));
               A5DocenteNombres = H000D2_A5DocenteNombres[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A5DocenteNombres", A5DocenteNombres);
               A22AsignaturaId = H000D2_A22AsignaturaId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A22AsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(A22AsignaturaId), 4, 0)));
               A4DocenteId = H000D2_A4DocenteId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A4DocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(A4DocenteId), 4, 0)));
               /* Execute user event: E120D2 */
               E120D2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDocenteNombres", AV8cDocenteNombres);
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {AV9pCargaLectivaId, AV6cDocenteId, AV7cAsignaturaId, lV8cDocenteNombres, AV12cCategoriaId});
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               AV7cAsignaturaId = (short)(context.localUtil.CToN( cgiGet( edtavCasignaturaid_Internalname), ",", ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7cAsignaturaId), 4, 0)));
            }
            AV8cDocenteNombres = cgiGet( edtavCdocentenombres_Internalname) ;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDocenteNombres", AV8cDocenteNombres);
            ...
            {
               AV12cCategoriaId = (short)(context.localUtil.CToN( cgiGet( edtavCcategoriaid_Internalname), ",", ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cCategoriaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12cCategoriaId), 4, 0)));
            }
            /* Read saved values. */
            nRC_Grid1 = (short)(context.localUtil.CToN( cgiGet( "nRC_Grid1"), ",", ".")) ;
            AV9pCargaLectivaId = (short)(context.localUtil.CToN( cgiGet( "vPCARGALECTIVAID"), ",", ".")) ;
            AV10pDocenteId = (short)(context.localUtil.CToN( cgiGet( "vPDOCENTEID"), ",", ".")) ;
            AV11pAsignaturaId = (short)(context.localUtil.CToN( cgiGet( "vPASIGNATURAID"), ",", ".")) ;
      ...
      {
         /* Enter Routine */
         AV10pDocenteId = A4DocenteId ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pDocenteId), 4, 0)));
         AV11pAsignaturaId = A22AsignaturaId ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pAsignaturaId), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV10pDocenteId,(short)AV11pAsignaturaId});
      ...
      protected void wb_table2_9_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_33_0D2( true) ;
         }
         else
         {
            wb_table3_33_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table3_33_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_33_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 36 )
         {
            ...
            wb_table4_44_0D2( true) ;
         }
         else
         {
            wb_table4_44_0D2( false) ;
         }
         return  ;
      }

      protected void wb_table4_44_0D2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_33_0D2e( true) ;
         }
         else
         {
            wb_table3_33_0D2e( false) ;
         }
      }

      protected void wb_table4_44_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(36), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_44_0D2e( true) ;
         }
         else
         {
            wb_table4_44_0D2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_0D2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdocenteid_Internalname, "Docente Id", "", "", lblTextblockdocenteid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6cDocenteId), 4, 0)));
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdocenteid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cDocenteId), 4, 0, ",", "")), context.localUtil.Format( (decimal)(AV6cDocenteId), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", "", "", "", "", edtavCdocenteid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, true, "right", "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockasignaturaid_Internalname, "Asignatura Id", "", "", lblTextblockasignaturaid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7cAsignaturaId), 4, 0)));
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCasignaturaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cAsignaturaId), 4, 0, ",", "")), context.localUtil.Format( (decimal)(AV7cAsignaturaId), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(19);\"", "", "", "", "", edtavCasignaturaid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, true, "right", "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdocentenombres_Internalname, "Docentes", "", "", lblTextblockdocentenombres_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cDocenteNombres", AV8cDocenteNombres);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdocentenombres_Internalname, StringUtil.RTrim( AV8cDocenteNombres), StringUtil.RTrim( context.localUtil.Format( AV8cDocenteNombres, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(24);\"", "", "", "", "", edtavCdocentenombres_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, true, "left", "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockcategoriaid_Internalname, "Categoria Id", "", "", lblTextblockcategoriaid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cCategoriaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12cCategoriaId), 4, 0)));
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCcategoriaid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12cCategoriaId), 4, 0, ",", "")), context.localUtil.Format( (decimal)(AV12cCategoriaId), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(29);\"", "", "", "", "", edtavCcategoriaid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, true, "right", "HLP_Gx00B1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9pCargaLectivaId = Convert.ToInt16(getParm(obj,0)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pCargaLectivaId), 4, 0)));
         AV10pDocenteId = Convert.ToInt16(getParm(obj,1)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pDocenteId), 4, 0)));
         AV11pAsignaturaId = Convert.ToInt16(getParm(obj,2)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pAsignaturaId), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?221380");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00b1.js", "?221381");
      ...
      protected void sendrow_362( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_36_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A4DocenteId), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A22AsignaturaId), 4, 0, ",", "")))+"'"+"]);" ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            edtDocenteNombres_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A4DocenteId), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A22AsignaturaId), 4, 0, ",", "")))+"'"+"]);" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV8cDocenteNombres = "" ;
         H000D2_A7CategoriaId = new short[1] ;
         H000D2_A18CargaLectivaId = new short[1] ;
         H000D2_A5DocenteNombres = new String[] {""} ;
         H000D2_A22AsignaturaId = new short[1] ;
         H000D2_A4DocenteId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00b1__default(),
            new Object[][] {
                new Object[] {
               H000D2_A7CategoriaId, H000D2_A18CargaLectivaId, H000D2_A5DocenteNombres, H000D2_A22AsignaturaId, H000D2_A4DocenteId
               }
               , new Object[] {
      ...
      private short AV9pCargaLectivaId ;
      private short wcpOAV9pCargaLectivaId ;
      private short nGotPars ;
      private short GxWebError ;
      private short nRC_Grid1 ;
      private short nGXsfl_36_idx=1 ;
      private short AV6cDocenteId ;
      private short AV7cAsignaturaId ;
      private short AV12cCategoriaId ;
      private short AV10pDocenteId ;
      private short AV11pAsignaturaId ;
      ...
      private String AV8cDocenteNombres ;
      private String A5DocenteNombres ;
      private String lV8cDocenteNombres ;
      ...
      private short[] H000D2_A7CategoriaId ;
      private short[] H000D2_A18CargaLectivaId ;
      private String[] H000D2_A5DocenteNombres ;
      private short[] H000D2_A22AsignaturaId ;
      private short[] H000D2_A4DocenteId ;
      private int[] H000D3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pDocenteId ;
      private short aP2_pAsignaturaId ;
   ...
   public class gx00b1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV9pCargaLectivaId",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV6cDocenteId",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV7cAsignaturaId",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@lV8cDocenteNombres",SqlDbType.VarChar,100,0} ,
          new Object[] {"@AV12cCategoriaId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000D3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [CategoriaId], [CargaLectivaId], [DocenteNombres], [AsignaturaId], [DocenteId] FROM [CargaLectivaDocente] WITH (NOLOCK) WHERE ([CargaLectivaId] = @AV9pCargaLectivaId and [DocenteId] >= @AV6cDocenteId and [AsignaturaId] >= @AV7cAsignaturaId) AND ([DocenteNombres] like @lV8cDocenteNombres) AND ([CategoriaId] >= @AV12cCategoriaId) ORDER BY [CargaLectivaId], [DocenteId], [AsignaturaId]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,11,0,false,false )
             ,new CursorDef("H000D3", "SELECT COUNT(*) FROM [CargaLectivaDocente] WITH (NOLOCK) WHERE ([CargaLectivaId] = @AV9pCargaLectivaId and [DocenteId] >= @AV6cDocenteId and [AsignaturaId] >= @AV7cAsignaturaId) AND ([DocenteNombres] like @lV8cDocenteNombres) AND ([CategoriaId] >= @AV12cCategoriaId) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1,0,false,false )
          };
       }
    }
