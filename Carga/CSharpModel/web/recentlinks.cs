/*
       ...
       Generated on: 12/3/2014 8:48:34.36
...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         {
            context.AddJavascriptSource("recentlinks.js", "?8483441");
         }
      ...
      private void E11022( )
      {
         ...
         AV8Session.Set("RecentLinks", AV11RecentLinksItems.ToXml(false, "LinkList", "Carga"));
         AV9i = 1 ;
         while ( AV9i <= AV11RecentLinksItems.Count )
         {
            AV12RecentLinksItem = ((SdtLinkList_LinkItem)AV11RecentLinksItems.Item(AV9i)) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?8483455");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?8483455");
         }
      ...
      public override void initialize( )
      {
         ...
         AV11RecentLinksItems = new GxObjectCollection( context, "LinkList.LinkItem", "Carga", "SdtLinkList_LinkItem", "GeneXus.Programs");
