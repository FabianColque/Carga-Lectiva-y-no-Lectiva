/*
               File: Gx0081
        Description: Selection List Linea
             Author: GeneXus C# Generator version 10_1_7-53786
       Generated on: 9/28/2014 21:46:48.32
...
namespace GeneXus.Programs {
   public class gx0081 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         this.AV8pCargaLectivaId = aP0_pCargaLectivaId;
         this.AV9pDocenteId = 0 ;
         executePrivate();
         aP1_pDocenteId=this.AV9pDocenteId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8pCargaLectivaId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pCargaLectivaId), 4, 0)));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1 ;
               ...
               gxgrGrid1_refresh( Grid1_PageSize26, AV6cDocenteId, AV7cDocenteNombres, AV8pCargaLectivaId) ;
               return  ;
            }
            else
            {
            ...
            if ( ! entryPointCalled )
            {
               AV8pCargaLectivaId = (short)(NumberUtil.Val( gxfirstwebparm, ".")) ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pCargaLectivaId), 4, 0)));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV9pDocenteId = (short)(NumberUtil.Val( GetNextPar( ), ".")) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("gx0081.aspx") + "?" + UrlEncode("" +AV8pCargaLectivaId) + "," + UrlEncode("" +AV9pDocenteId)+"\" class=\""+"Form"+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPCARGALECTIVAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pCargaLectivaId), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx0081.aspx") + "?" + UrlEncode("" +AV8pCargaLectivaId) + "," + UrlEncode("" +AV9pDocenteId) ;
      }
      ...
      protected void START0B2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List Linea", 0) ;
         context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              edtDocenteNombres_Internalname = "DOCENTENOMBRES_"+sGXsfl_26_idx ;
      ...
      protected void RF0B2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDocenteNombres", AV7cDocenteNombres);
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {AV8pCargaLectivaId, AV6cDocenteId, lV7cDocenteNombres});
            nGXsfl_26_idx = 1 ;
            GRID1_nEOF = 0 ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < GRID1_nFirstRecordOnPage + subGrid1_Recordsperpage( ) ) ) ) )
            {
               A18CargaLectivaId = H000B2_A18CargaLectivaId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A18CargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(A18CargaLectivaId), 4, 0)));
               A5DocenteNombres = H000B2_A5DocenteNombres[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A5DocenteNombres", A5DocenteNombres);
               A4DocenteId = H000B2_A4DocenteId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A4DocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(A4DocenteId), 4, 0)));
               /* Execute user event: E120B2 */
               E120B2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDocenteNombres", AV7cDocenteNombres);
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV8pCargaLectivaId, AV6cDocenteId, lV7cDocenteNombres});
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV8pCargaLectivaId = (short)(context.localUtil.CToN( cgiGet( "vPCARGALECTIVAID"), ",", ".")) ;
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Linea", "", "", "", "", "", "", "", "") ;
      ...
      protected void wb_table2_9_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_23_0B2( true) ;
         }
         else
         {
            wb_table3_23_0B2( false) ;
         }
         return  ;
      }

      protected void wb_table3_23_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</fieldset>") ;
      ...
      protected void wb_table3_23_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 26 )
         {
            ...
            wb_table4_33_0B2( true) ;
         }
         else
         {
            wb_table4_33_0B2( false) ;
         }
         return  ;
      }

      protected void wb_table4_33_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_23_0B2e( true) ;
         }
         else
         {
            wb_table3_23_0B2e( false) ;
         }
      }

      protected void wb_table4_33_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(26), 3, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "rounded", "ECANCEL.", TempTags, "", context.GetButtonType( ), "HLP_Gx0081.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_33_0B2e( true) ;
         }
         else
         {
            wb_table4_33_0B2e( false) ;
         }
      }
      ...
      protected void wb_table2_9_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdocenteid_Internalname, "Docente Id", "", "", lblTextblockdocenteid_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0081.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6cDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6cDocenteId), 4, 0)));
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdocenteid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cDocenteId), 4, 0, ",", "")), context.localUtil.Format( (decimal)(AV6cDocenteId), "ZZZ9"), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(14);\"", "", "", "", "", edtavCdocenteid_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, true, "right", "HLP_Gx0081.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockdocentenombres_Internalname, "Docente Nombres", "", "", lblTextblockdocentenombres_Jsonclick, "", StyleString, ClassString, 0, "", 1, 1, 0, "HLP_Gx0081.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cDocenteNombres", AV7cDocenteNombres);
            ...
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtavCdocentenombres_Internalname, StringUtil.RTrim( AV7cDocenteNombres), StringUtil.RTrim( context.localUtil.Format( AV7cDocenteNombres, "")), TempTags+" onchange=\"gx.evt.onchange(this)\" "+" onblur=\""+""+";gx.evt.onblur(19);\"", "", "", "", "", edtavCdocentenombres_Jsonclick, 0, ClassString, StyleString, "", 1, 1, 0, 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, true, "left", "HLP_Gx0081.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pCargaLectivaId = Convert.ToInt16(getParm(obj,0)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pCargaLectivaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pCargaLectivaId), 4, 0)));
         AV9pDocenteId = Convert.ToInt16(getParm(obj,1)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9pDocenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9pDocenteId), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?21464860");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0081.js", "?21464860");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Linea" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV7cDocenteNombres = "" ;
         H000B2_A18CargaLectivaId = new short[1] ;
         H000B2_A5DocenteNombres = new String[] {""} ;
         H000B2_A4DocenteId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0081__default(),
            new Object[][] {
                new Object[] {
               H000B2_A18CargaLectivaId, H000B2_A5DocenteNombres, H000B2_A4DocenteId
               }
               , new Object[] {
      ...
      private short AV8pCargaLectivaId ;
      private short wcpOAV8pCargaLectivaId ;
      ...
      private short[] H000B2_A18CargaLectivaId ;
      private String[] H000B2_A5DocenteNombres ;
      private short[] H000B2_A4DocenteId ;
   ...
   public class gx0081__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV8pCargaLectivaId",SqlDbType.SmallInt,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT [CargaLectivaId], [DocenteNombres], [DocenteId] FROM [CargaLectivaLinea] WITH (NOLOCK) WHERE ([CargaLectivaId] = @AV8pCargaLectivaId and [DocenteId] >= @AV6cDocenteId) AND ([DocenteNombres] like @lV7cDocenteNombres) ORDER BY [CargaLectivaId], [DocenteId]  OPTION (FAST 11)",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,11,0,false,false )
             ,new CursorDef("H000B3", "SELECT COUNT(*) FROM [CargaLectivaLinea] WITH (NOLOCK) WHERE ([CargaLectivaId] = @AV8pCargaLectivaId and [DocenteId] >= @AV6cDocenteId) AND ([DocenteNombres] like @lV7cDocenteNombres) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1,0,false,false )
          };
       }
    }
